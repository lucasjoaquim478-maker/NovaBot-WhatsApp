...
const menu = {
  ...
  owner: { emoji: '👑', title: 'DONO DO BOT', header: true, cmds: [
    ...
    ['warp', 'Proxy Cloudflare WARP SOCKS5'],
    ['proxytest', 'Buscar + testar proxies BR'],
    ['proxyauto', 'Auto-configurar proxy'],
    ['setproxy [url]', 'Configurar proxy manual'],
    ['delproxy', 'Remover proxy'],
    ['invidious', 'Testar instancias Invidious'],
    ['addcookie', 'Enviar cookies.txt (arquivo)'],
    ['delcookie', 'Remover cookies'],
    ['cookieinfo', 'Ver info dos cookies'],
    ['upgrade', 'Atualizar yt-dlp'],
  ]},
